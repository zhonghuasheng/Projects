...
<html>
  ...
  <body>
    ...
    <div class="content float-left">
      <div class="panel">
        <div class="row ml-0 mr-0">
          ...
          <div class="action col-sm-1">
            <div class="float-right">
              <a class="btn btn-success" href="<%=basePath%>/admin/music/create">创建</a>
            </div>
          </div>
        </div>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary btn-sm btn-yes" data-uuid="" data-dismiss="modal" onclick="deleteMusic()">是</button>
      ...
      <script src="<%=basePath%>/static/js/music/list.js"></script>
    </div>
  </body>
  <script>
